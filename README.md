...
This table lists the configuration variables required to operate Zscaler. These variables are specified when configuring a Zscaler asset in Splunk SOAR.
